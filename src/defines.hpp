...
//#define D3Q19 // choose D3Q19 velocity set for 3D; allocates 93 (FP32) or 55 (FP16) Bytes/cell
//#define D3Q27 // choose D3Q27 velocity set for 3D; allocates 125 (FP32) or 71 (FP16) Bytes/cell

#if !defined(D2Q9) && !defined(D3Q15) && !defined(D3Q19) && !defined(D3Q27)
#define D3Q19 // default velocity set
#endif

//#define SRT // choose single-relaxation-time LBM collision operator
//#define TRT // choose two-relaxation-time LBM collision operator
#if !defined(SRT) && !defined(TRT)
#define SRT // default collision operator
#endif
...
//#define INTERACTIVE_GRAPHICS // enable interactive graphics; start/pause the simulation by pressing P; requires native macOS windowing in this branch
